        ...
        if qprod == 0:
            while True:
                ...
                if sistema.localizar_usuario(dados,nome,'nome'):
                    ...
                    match cad:
                        case 1:
                            sistema.escreva_arq(arquivo,sistema.cadastrar_usuario(nome), sobrescreva=True)
            ...
            case 1:
                while True:
                    ...
                    for u in dados:
                        ...
                        break
                oparquivo.escreva_arq(arquivo,cadastrar_usuario(new_user), sobrescreva=True)
            case 2:
                while True:
                    console.clear()
                            ...
                            match opc:
                                ...
                                case 4:
                                    ...
                                    if validar.valida_sn(' [ S / N ]\n → '):
                                        del dados[dados.index(show_user)]
